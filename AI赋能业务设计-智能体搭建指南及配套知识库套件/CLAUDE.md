...
> **导航**: [根目录](../../CLAUDE.md) > **指南套件模块**

---

## 📋 模块概述

**模块名称**: AI赋能业务设计-智能体搭建指南及配套知识库套件  
**模块类型**: 文档库/知识库  
**模块定位**: 完整的Trae IDE操作指南，整合AI辅助业务设计执行脚本和6A工作流程
...
| 子模块 | 路径 | 说明 | 关键文件 |
|--------|------|------|----------|
| 工具安装包 | `00-工具安装包/` | Trae CN、Node.js、Python安装包和安装指南 | `安装网址.md` |
| 完整指南 | `01-完整指南/` | 零基础操作指南和执行脚本 | `00-Trae IDE 零基础小白操作指南.md`<br>`01-Trae IDE 辅助业务设计具体执行脚本.md` |
...
#### 1. README.md
- **位置**: `AI赋能业务设计-智能体搭建指南及配套知识库套件/README.md`
