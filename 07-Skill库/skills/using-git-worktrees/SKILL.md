...
description: 在启动需要与当前工作区隔离的功能工作或在执行实施计划之前使用 - 创建具有智能目录选择和安全验证的隔离 git 工作树
---
...
- **修复：** 始终在创建项目本地工作树之前使用 `git check-ignore`
