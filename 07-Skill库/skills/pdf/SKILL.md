...
license: 专有许可。LICENSE.txt包含完整条款
---
...
本指南介绍使用Python库和命令行工具进行PDF处理的基本操作。有关高级功能、JavaScript库和详细示例，请参阅reference.md。如果您需要填写PDF表单，请阅读forms.md并按照其说明操作。
...
# 这将提取所有图片为 output_prefix-000.jpg, output_prefix-001.jpg 等
```
...
| 填写PDF表单 | pdf-lib或pypdf (参见forms.md) | 参见forms.md |
